...
def infer_rare_cancer_report_scope_from_rna(df_expr, analysis):
    ...
    This compatibility helper delegates the report-scope decision to the
    unified cancer-type evidence selector. Marker prompts are still generated
    here from the data-backed rare-cancer rule table.
    """
